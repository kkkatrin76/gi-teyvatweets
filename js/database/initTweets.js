...
Tweets.push(new Tweet(
    ...
    [
        new Tweet(
            ++i,
            meirin,
            "❤️🥰💞💘💐🌼💗 yes my lord whatever you say my lord",
            "1m",
        ),
        new Tweet(
            ++i,
...
Tweets.push(new Tweet(
    ++i,
    BitesTheDust,
    "Just had to talk to the new Grand Sage of the Akademiya today...and WTF I might go back to uni??? Why did no one tell me they got such a hottie for the position. Excuse me but??<br>   ↳ <a href='https://twitter.com/_yuelight/status/1649763266380328963' target='_blank'>[source]</a>",
    "1h",
    ...
    [
        ...
        new Tweet(
            ++i,
            kaveh,
            "<span class='tag'>@scribealhaitham</span> Excuse me what ☠️",
            "1h",
        ),
        new Tweet(
            ++i,
        ...
        new Tweet(
            ++i,
            solxilynx,
            "Excuse me while I just examine the evidence of your claim 🔍<br>..... Hm. Yes, I suppose those are some nice mantits.",
            "1h",
        ),
        new Tweet(
            ++i,
...
Tweets.push(new Tweet(
    ...
    [
        ...
        new Tweet(
            ++i,
            meirin,
            "🥰 oh you ☺️ ofc, anything for my hubby <3",
            "3h",
        ),
        new Tweet(
            ++i,
            childe,
            "😃😃😃 for the love of tsaritsa, get a room you two",
            "3h",
        ),
        new Tweet(
            ++i,
